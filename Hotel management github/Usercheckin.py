...
Label(root, text="Phone Number", font=("Times New Roman",15), bg='#e2d9cc').place(x=100, y=340)
Label(root, text="Address", font=("Times New Roman",15), bg='#e2d9cc').place(x=100, y=390)
Label(root, text="Email ID", font=("Times New Roman",15), bg='#e2d9cc').place(x=100, y=440)
Label(root, text="Type of room", font=("Times New Roman",15), bg='#e2d9cc').place(x=100, y=490)
Label(root, text="Check-in date", font=("Times New Roman",15), bg='#e2d9cc').place(x=100, y=540)
Label(root, text="Check-out date", font=("Times New Roman",15), bg='#e2d9cc').place(x=100, y=590)
Label(root, text="The Aviary", font=("Algerian",35), bg='#e2d9cc').place(x=210, y=10)
Label(root, text="The Luxury Of Comfort ", font=("Times New Roman",30), bg='#e2d9cc').place(x=150, y=70)
Label(root, text="Check-in Credentials", font=("Century Gothic",30), bg='#e2d9cc').place(x=100, y=200)
Label(root, text="₹7,500", font=("Times New Roman",15), bg='#e2d9cc',fg='black').place(x=640, y=520)
Label(root, text="₹10,000", font=("Times New Roman",15), bg='#e2d9cc',fg='black').place(x=500, y=520)
